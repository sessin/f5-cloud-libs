 ...
 *                   {
 *                       id: NIC ID,
 *                       publicIp: public IP (or first public IP on the NIC)
 *                       privateIp: private IP (or first private IP on the NIC)
 *                   }
 */
 ...
 *                   {
 *                       id: instance ID,
 *                       publicIp: public IP (or first public IP on first NIC)
 *                       privateIp: private IP (or first private IP on first NIC)
 *                   }
 */
